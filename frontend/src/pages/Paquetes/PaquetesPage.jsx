...
const PaquetesPage = () => {
    ...
    return (
        ...
        <div className="min-h-screen relative text-white overflow-hidden" 
            ...
            {/* Superposición oscura para mantener contraste */}
            ...
            <div className="relative z-10 p-8">
                ...
                <div className="flex justify-between items-center mb-10">
                    ...
                    <button onClick={handleOpenNew}
                        className="bg-red-700 hover:bg-red-600 px-6 py-3 rounded-xl font-bold transition-all shadow-lg hover:shadow-red-900/20"
                    >
                        + Nuevo
                    </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {paquetes.map((p) => (
                        <div key={p.id_paquete} className="bg-[#141414]/80 border border-red-900/30 rounded-2xl p-6 shadow-xl backdrop-blur-md hover:border-red-700/50 transition-colors">
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                        <div className="bg-[#141414] border border-red-900/30 rounded-2xl p-8 max-w-md w-full shadow-2xl">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex gap-3 mt-6">
                                    ...
                                    <button type="button" onClick={() => setIsModalOpen(false)} className="flex-1 bg-gray-700 py-3 rounded-lg hover:bg-gray-600 transition-colors">Cerrar</button>
                                </div>
                            </form>
                        </div>
                    </div>
